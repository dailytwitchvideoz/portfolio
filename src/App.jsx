...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-100 to-stone-100 flex flex-col font-sans">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between max-w-6xl mx-auto">
          <div className="flex items-center mb-3 md:mb-0">
            <img
              src={logo}
              alt="Mert Cila Logo"
              className="h-16 w-16 rounded-full object-cover border-2 border-amber-400 mr-3"
            />
            <div>
              <h1 className="text-3xl md:text-4xl font-display font-bold text-black drop-shadow tracking-tight">
                Mert Cila
              </h1>
              <p className="text-black text-sm md:text-lg font-sans tracking-wide">
                Lake ve Cila Atölyesi
              </p>
            </div>
          </div>
      ...
      {/* Hakkında */}
      <section
        className="flex-1 flex flex-col items-center justify-center px-4 py-16 md:py-28 bg-gradient-to-b from-amber-50/80 to-yellow-100/60"
        id="about"
      >
        <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-amber-700 drop-shadow">
          Hakkımızda
        </h2>
        <div className="max-w-3xl text-stone-700 text-center bg-white/60 rounded-xl p-6 shadow-md">
          <p className="text-lg md:text-2xl leading-relaxed mb-4">
            Mert Cila, mobilya ve ahşap yüzeyler için profesyonel lake ve cila
            uygulamaları sunar. 20+ yıllık tecrübe, modern ekipman ve müşteri
            memnuniyeti odaklı hizmet ile yaşam alanlarınızı yeniliyoruz.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-amber-50/80 p-4 rounded-lg shadow-sm">
              ...
              <p className="text-stone-600">
                Ahşap mobilyalarınızın doğal güzelliklerini ortaya çıkaran
                profesyonel lake ve cila uygulamaları.
              </p>
            </div>
            <div className="bg-amber-50/80 p-4 rounded-lg shadow-sm">
              <h3 className="text-amber-800 font-bold text-xl mb-2">Kalite</h3>
              <p className="text-stone-600">
                Yüksek kaliteli malzemeler ve uzman işçilik ile uzun ömürlü
            ...
            <div className="bg-amber-50/80 p-4 rounded-lg shadow-sm">
              ...
              <p className="text-stone-600">
                Zamanında teslim ve bütçenize uygun çözümler ile müşteri
      ...
      <section
        className="bg-gradient-to-br from-white via-amber-50 to-yellow-100 py-16 px-4"
        id="gallery"
      >
        <h2 className="text-3xl md:text-4xl font-display font-bold mb-10 text-amber-700 text-center drop-shadow">
          Son Çalışmalarımız
        </h2>

        <div className="flex justify-center mb-8">
          <div className="inline-flex bg-white/70 rounded-full shadow-md p-1.5">
            <button className="px-4 py-2 rounded-full bg-amber-600 text-white font-medium">
              Tüm Çalışmalar
            </button>
      ...
      {/* İletişim */}
      <section
        className="py-14 px-4 bg-gradient-to-t from-amber-50 to-yellow-100/60"
        id="contact"
      >
        <h2 className="text-3xl md:text-4xl font-display font-bold mb-6 text-amber-700 text-center drop-shadow">
          İletişim
        </h2>
        <div className="max-w-lg mx-auto flex flex-col gap-4 text-center bg-white/70 rounded-2xl shadow-lg p-8 border border-amber-100">
          ...
          <p className="text-stone-800 text-lg">
            Adres: Marmara Sanayi Sitesi E.Blok No:5/6 İkitelli/İstanbul TR,
            34307
          </p>
          <div className="mt-4">
            <p className="text-stone-800 text-lg font-medium mb-2">
              Çalışma Saatleri:
            </p>
      ...
      <div className="fixed right-6 bottom-6 z-50">
        ...
        <div
          className="absolute inset-0 rounded-full bg-white/30 opacity-60 blur-sm animate-glow"
      ...
      <div className="fixed left-6 bottom-6 z-50">
        ...
        ></div>
        <div
          className="absolute inset-0 rounded-full bg-amber-300 opacity-50 animate-ping"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center">
              <img
                src={logo}
                alt="Mert Cila Logo"
                className="h-12 w-12 rounded-full object-cover border-2 border-amber-400 mr-3"
              />
              <div>
            ...
            <div className="flex flex-col items-center md:items-end">
              <p className="text-amber-200 text-sm">
                &copy; {new Date().getFullYear()} Mert Cila - Tüm Hakları
                Saklıdır
              </p>
